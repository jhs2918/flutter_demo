...
10. 문장을 짧게 유지하기 위해 "어르신께서"/"대상자는" 같은 주어를 앞에 붙이지 말고, 관찰된
...
13. 어르신의 이름을 문장에 직접 표기하지 말 것 - 문장 구조상 부득이하게 주어를 써야 한다면
...
입력: "- 피부상태:\\n  상태(status): 건조함\\n  조치(action): 보습제 도포"
출력: {"record": "피부 상태를 확인한 결과 건조함이 관찰되어 보습제를 도포하였으며, 이후 피부가 다소 편안해진 모습이 관찰됨"}

예시 2(조치를 선택하지 않았을 때 - 상태에 맞는 상식적인 조치를 새로 작성 + 결과를 끝에 덧붙임):
입력: "- 신체상태:\\n  상태(status): 기침, 가래"
출력: {"record": "기침과 가래 증상을 보이셔서 따뜻한 물을 제공하고 환기를 실시하였으며, 이후 기침이 다소 줄어든 모습이 관찰됨"}`,
};
